  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <Suspense fallback={<div className="h-64 flex items-center justify-center"><div className="w-6 h-6 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" /></div>}>
          <LoginForm />
        </Suspense>
      </motion.div>
    </div>
